...
def create_world(background, draw_obstacles=False):
    """
    This function is used to create the world for pygame where the robots live.
    """
...
def mainloop(bn_robot, draw_obstacles):
    ...
    allrobots, allobstacles, alltargets, allsounds  = create_world(background, draw_obstacles)
